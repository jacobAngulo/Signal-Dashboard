...
function columnSet({ scale, hasSim, sparkWidth }) {
  return {
    ...
    call: {
      ...
      title: "decision, and the producer's own holding window — Foundry publishes the extraction model's own word, not a session count",
    ...
    metric: {
      ...
      title: 'Foundry event signal score',
      render: (r) => (
        <span>
          {fmtNum(r.metric, 3)}{' '}
