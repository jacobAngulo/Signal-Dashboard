...
// One hue per producer, held apart by hue angle rather than by brightness. Only
// cyan Foundry is left. `color` is the line/mark hue and `text` the brighter
// on-canvas variant; both come from styles.css via theme.js so the charts and the
